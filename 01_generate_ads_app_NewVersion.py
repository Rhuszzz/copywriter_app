...
def main():
    ...
    if st.button("광고 문구 생성"):
        prompt = f'''
        Based on the information below, write 5 taglines that is 1 to 2 lines long and in Korean Language.
        - product name: {name}
        - brand name: {com_name}
        - brand core value: {value}
        - product features: {strenghth}
        - tone and manner: {tone_manner}
        - required keywords: {keyword}
        '''
